...
${repoUrl ? `\n   🔗 GitHub: ${repoUrl}\n` : ''}`);
    ...
    async createGitHubRepo(projectName, outputDir) {
        ...
        await this.runWithSpinner('Creating GitHub repository…', async () => {
            ...
            const result = await execa('gh', ['repo', 'create', projectName, visibility, '--source=.', '--remote=origin', '--push'], { cwd: outputDir });
...
Init.description = 'Scaffold a new project from a template';
Init.examples = [
    '$ kode init my-api',
